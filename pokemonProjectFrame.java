...
public class pokemonProjectFrame extends javax.swing.JFrame {
   ...
   private void pokemonSpecieList(){
    ...
    private void myPokemonList(){
        ...
        //tablePokemonList.getColumn("Level-Up").setCellRenderer(new ButtonRenderer());
        //tablePokemonList.getColumn("Level-Up").setCellEditor(new ButtonEditor(new JTextField()));
